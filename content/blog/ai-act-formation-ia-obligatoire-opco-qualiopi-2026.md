...
# SEO
keywords: ["AI Act formation obligatoire", "article 4 AI Act maîtrise de l'IA", "formation IA OPCO CPF", "Qualiopi formation IA financement", "AI literacy PME France 2026", "obligation formation salariés IA", "financer formation IA entreprise"]
canonical: ""

# Catégories & Tags
categories: ["Réglementation IA"]
tags: ["AI Act", "Formation IA", "OPCO", "Qualiopi", "Conformité", "AI literacy", "PME"]
...
# Image & Affichage
image: "/assets/images/blog/ai-act-formation-ia-obligatoire-opco-qualiopi-2026.webp"
imageAlt: "Réglementation européenne AI Act et formation des collaborateurs à l'IA — de la loi à la pratique"
emoji: ""
...
Cet article est [entré en application le 2 février 2025](https://liftia.ai/ai-act-obligation-de-former-salaries-ia/). L'obligation est effective maintenant — pas en 2026.
...
## PME françaises : êtes-vous vraiment concernés ?
...
[Selon le Service Public français](https://entreprendre.service-public.gouv.fr/actualites/A18475), dès lors qu'une organisation "déploie" un système d'IA dans son activité professionnelle, elle est soumise aux obligations du règlement. La taille de l'entreprise n'est pas un critère d'exemption.
...
[La CNIL le rappelle régulièrement](https://www.dastra.eu/fr/article/ai-act-quelles-obligations-sappliquent-des-le-2-fevrier-2025/58851) : les traitements de données personnelles réalisés via des outils d'IA non encadrés peuvent engager simultanément la responsabilité de votre entreprise au titre du RGPD et de l'AI Act. Former vos équipes, c'est traiter les deux risques d'un seul geste.
...
- **Atlas** : conseil, numérique, communication, banque-assurance
- **Akto** : commerce, services à la personne, hôtellerie-restauration
- **OPCO 2i** : industrie, métallurgie, chimie
- **Constructys** : bâtiment et travaux publics
- **Uniformation** : économie sociale et solidaire

En 2026, la [transformation numérique — dont l'IA — figure parmi les priorités sectorielles de la quasi-totalité des OPCO](https://aisisters.ai/post/financement-formation-ia-opco-cpf-plan-competences). Les budgets dédiés sont en hausse.

**Niveaux de prise en charge typiques :**

| Taille de l'entreprise | Prise en charge |
|------------------------|-----------------|
| Moins de 50 salariés | Jusqu'à **100 %** des coûts pédagogiques |
| 50 à 300 salariés | Entre **30 et 70 %** selon l'OPCO et le secteur |
...
- [Règlement (UE) 2024/1689 — Texte officiel de l'AI Act](https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX:32024R1689), EUR-Lex, Parlement européen et Conseil de l'UE, 2024
- [AI Act : les entreprises ont l'obligation de former leurs salariés à l'IA depuis février 2025](https://liftia.ai/ai-act-obligation-de-former-salaries-ia/), Liftia, 2025
- [AI Act : quels changements pour les entreprises ?](https://entreprendre.service-public.gouv.fr/actualites/A18475), Service Public Entreprendre
- [Quelles obligations s'appliquent dès le 2 février 2025 ?](https://www.dastra.eu/fr/article/ai-act-quelles-obligations-sappliquent-des-le-2-fevrier-2025/58851), Dastra, 2025
- [Non-conformité à l'AI Act : quelles sanctions pour votre entreprise ?](https://www.agn-avocats.fr/blog/droit-des-affaires/intelligence-artificielle/non-conformite-a-l-ai-act-quelles-sanctions-pour-votre-entreprise/), AGN Avocats
- [Article 4 — Maîtrise de l'IA](https://mdc-avocat.fr/ria-ai-act-article-4-maitrise-de-lia/), Marine de la Clergerie, Avocate
...
- [OPCO, CPF, Plan de développement des compétences : comment financer votre formation IA](https://aisisters.ai/post/financement-formation-ia-opco-cpf-plan-competences), AI Sisters, 2026
- [Comment financer votre plan de formation en 2026](https://www.focus-ai.fr/blog/comment-financer-votre-plan-de-formation-en-2026-le-guide-des-aides-pour-entreprises-(opco-fne-cpf-)), Focus IA, 2026
- [AI Act : que doivent faire les RH dès 2025 ?](https://www.unow.fr/blog/actualites/ai-act-que-doivent-faire-les-rh-des-2025/), Unow, 2025
