...
Pendant ce temps, la pression s'intensifie. La pénurie de collaborateurs atteint des niveaux critiques avec **30 000 postes à pourvoir d'ici 2025** selon l'[OMECA](https://www.metierscomptabilite.fr/). La facturation électronique obligatoire arrive en 2026. Et l'IA Act européen impose désormais une obligation de formation aux outils d'intelligence artificielle.
...
Les chiffres sont sans appel. L'[Observatoire des Métiers de l'Expertise Comptable (OMECA)](https://www.compta-online.com/enquete-omeca-ao231) documente une situation critique : **66% des cabinets rencontrent des difficultés de recrutement**, avec 13 000 nouveaux emplois créés ces dernières années face à un vivier de candidats insuffisant.
...
Le [cabinet Émargence](https://dext.com/fr/ressources/cas-clients-temoignages/emargence), 120 collaborateurs à Paris, fait figure de référence dans la transformation digitale de la profession. Sous l'impulsion de Stéphane Mariette, associé fondateur, le cabinet a entamé sa digitalisation dès 2016, bien avant la vague actuelle.
...
*"Ce matin j'ai traité 120 factures de vente en une demi-heure, tout en voyant ce qui se passe ! L'intelligence artificielle me fait effectivement gagner beaucoup de temps"*, explique William Denis dans le [cas client publié par Cegid](https://www.cegid.com/fr/cas-client/le-cabinet-william-denis-et-associe-economise-entre-50-et-60-du-temps-de-traitement-des-pieces-grace-a-cegid-loop/).
...
*"Ces deux outils me font gagner 5 à 6 heures par dossier"*, précisait Louis Cléon lors d'un [webinar consacré à l'IA dans la révision comptable](https://www.cegid.com/fr/solutions/expertise-comptable/intelligence-artificielle-pour-experts-comptables/), organisé par Cegid.
...
L'étude ["Navigating the Jagged Technological Frontier"](https://www.hbs.edu/faculty/Pages/item.aspx?num=64700), menée conjointement par la Harvard Business School, le MIT, la Wharton School et le BCG Henderson Institute auprès de 758 consultants, a mesuré des gains significatifs pour les utilisateurs de GPT-4 :
...
Vous vous demandez par où commencer concrètement dans votre cabinet ? Quels outils choisir ? Comment embarquer vos équipes ?

Nous proposons un **audit gratuit de 30 minutes** pour identifier vos 2-3 cas d'usage à plus fort potentiel, estimer les gains de temps réalistes pour votre structure, et définir une feuille de route adaptée à votre contexte.
...
*Sources : [Conseil National de l'Ordre des Experts-Comptables (CNOEC)](https://www.compta-online.com/ia-profession-expert-comptable-ao7637), [Observatoire des Métiers de l'Expertise Comptable (OMECA)](https://www.metierscomptabilite.fr/), [Harvard Business School / MIT / BCG Henderson Institute "Navigating the Jagged Technological Frontier"](https://www.hbs.edu/faculty/Pages/item.aspx?num=64700), [Cas client Émargence - Dext](https://dext.com/fr/ressources/cas-clients-temoignages/emargence), [Cas client William Denis - Cegid](https://www.cegid.com/fr/cas-client/le-cabinet-william-denis-et-associe-economise-entre-50-et-60-du-temps-de-traitement-des-pieces-grace-a-cegid-loop/), [IA pour experts-comptables - Cegid](https://www.cegid.com/fr/solutions/expertise-comptable/intelligence-artificielle-pour-experts-comptables/), [Baromètre France Num 2025](https://www.francenum.gouv.fr/guides-et-conseils/strategie-numerique/comprendre-le-numerique/barometre-france-num-2025-le).*
