---
title: "Personne n'est leader : ce que les IA citent vraiment quand on leur demande une agence"
seo_title: "Personne n'est leader : ce que citent vraiment les IA"
date: 2026-08-21
lastmod: 2026-08-21
description: "6 253 réponses de ChatGPT, Claude, Grok et Perplexity analysées sur 94 questions de dirigeants. Aucun acteur ne domine, et les réponses changent à chaque fois."
summary: "Étude originale menée sur notre propre outil de suivi des citations IA. 6 253 réponses de quatre moteurs génératifs à 94 questions de dirigeants de PME, 1 494 sources citées. Trois résultats : aucun acteur ne dépasse 22 % des réponses, la moitié des sources change quand on repose la même question, et 82 % des domaines ne sont cités que par un seul moteur. Le marché n'a pas de leader dans l'œil des IA."

# SEO
keywords: ["être cité par les IA", "citations IA entreprise", "visibilité IA PME", "quelle agence IA les IA recommandent", "GEO generative engine optimization", "sources citées par ChatGPT", "étude citations Perplexity", "suivi mentions IA"]
canonical: ""

# Catégories & Tags
categories: ["Visibilité IA"]
tags: ["GEO", "Visibilité IA", "ChatGPT", "Perplexity", "Claude", "Grok", "Étude", "PME"]

# Auteur & Crédibilité (E-E-A-T)
author: "Franck Sauvage"
expertise: "Fondateur L'Agence Sauvage, spécialiste déploiement IA pour PME françaises, auteur du GEO Citation Tracker"

# Image & Affichage
image: "/assets/images/blog/etude-citations-ia-agences-pme-2026.webp"
imageAlt: "Cible de fléchettes criblée sur ses anneaux extérieurs, le centre resté totalement vide"
emoji: ""
...
faq:
  - question: "Comment cette étude a-t-elle été menée ?"
    answer: "Nous exploitons notre propre outil de suivi, le GEO Citation Tracker, qui interroge automatiquement plusieurs moteurs génératifs sur un jeu de questions fixe et enregistre les réponses ainsi que les sources citées. Le corpus principal compte 6 253 réponses collectées entre février et juin 2026 sur 94 questions, auxquelles s'ajoute un corpus de contrôle de 56 réponses collectées le 21 août 2026 sur les sept questions les plus concurrentielles. Les quatre moteurs exploitables sont ChatGPT, Claude, Grok et Perplexity."
  - question: "Pourquoi Google Gemini est-il absent de l'étude ?"
...
| Rang | Acteur | Présent dans |
|---|---|---|
| 1 | un prestataire IA | 22,2 % des réponses |
| 2 | un annuaire de prestataires | 18,8 % |
| 3 | un prestataire IA | 17,8 % |
| 4 | une plateforme vidéo | 17,6 % |
| 5 | un organisme de formation | 14,7 % |
| 10 | un prestataire IA | 11,0 % |
...
| Moteur | Recouvrement entre deux réponses |
|---|---|
| Grok | 0,34 |
| ChatGPT | 0,44 |
| Perplexity | 0,63 |
...
| Moteur | Réponses citant au moins une source | Sources par réponse citante |
|---|---|---|
| Perplexity | 99 % | 9,0 |
| ChatGPT | 15 % | 4,9 |
| Grok | 15 % | 3,6 |
...
| Nature de la source | Part des citations | Domaines |
|---|---|---|
| Prestataires (agences, freelances, cabinets) | 83,6 % | 1 420 |
| Institutions publiques | 4,1 % | 24 |
| Plateformes (vidéo, réseaux, forums) | 3,2 % | 7 |
| Annuaires et places de marché | 3,0 % | 7 |
| Organismes de formation | 2,2 % | 5 |
| Éditeurs de logiciels | 2,0 % | 12 |
| Médias | 1,3 % | 16 |
| Encyclopédies | 0,6 % | 2 |
...
En face, quelques sources isolées pèsent lourd. [France Num](https://www.francenum.gouv.fr/), le programme de l'État pour la transformation numérique des entreprises, représente à lui seul **2,13 %** des citations, soit près du double du premier prestataire privé. Les plateformes suivent : YouTube pèse 1,16 %, Reddit 0,94 %, LinkedIn 0,64 %. Cumulés, ces trois-là dépassent les deux premières agences réunies.
...
| Formulation de la question | Nous sommes cités dans |
|---|---|
| Question mentionnant une agence ou un service précis | 11,9 % des réponses |
| Demande de liste d'agences | 5,7 % |
| Question de découverte pure, sans aucun indice | 0,4 % |
...
Nous appliquons cette méthode à nous-mêmes, et le résultat n'est pas flatteur : sur les sept questions les plus concurrentielles du corpus d'août, **L'Agence Sauvage n'apparaît qu'une fois sur 56 réponses**. C'est précisément pour cela que nous avons construit l'outil qui a produit cette étude, et que nous préférons publier le chiffre plutôt que de le taire. Le sujet de la [visibilité dans les moteurs génératifs](/blog/visibilite-ia-entreprise-cite-par-chatgpt/) se mesure ou ne se pilote pas, et la [méthode que nous appliquons sur nous-mêmes](/blog/seo-geo-2026-methode-visibilite-google-ia/) part de là.
...
Cette étude porte sur notre marché. La même mesure appliquée au vôtre donnerait d'autres noms, d'autres sources, et probablement les mêmes enseignements : un peloton sans tête, et une place à prendre. Si vous voulez savoir qui les moteurs citent dans votre secteur, [réservons 30 minutes](https://calendly.com/franck-lagencesauvage/30min) et nous le mesurons ensemble sur vos questions à vous.

## Sources et références

- [France Num, programme national de transformation numérique des entreprises](https://www.francenum.gouv.fr/)
- [GEO Citation Tracker, la réalisation qui a produit ces données](/realisations/geo-citation-tracker-visibilite-ia-marque/)
